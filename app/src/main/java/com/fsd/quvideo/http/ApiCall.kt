...
import com.fsd.quvideo.http.interceptor.CacheCookieInterceptor
import com.fsd.quvideo.http.interceptor.LogInterceptor
import com.fsd.quvideo.http.interceptor.ParamIntercaptor
import com.fsd.quvideo.http.interceptor.SetCookieInterceptor
  ...
  val okHttp: OkHttpClient
    get() {
      return OkHttpClient.Builder().run {
        ...
        addInterceptor(ParamIntercaptor())
        //不验证证书
